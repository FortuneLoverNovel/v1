...
[if exp="sf.keeth_cg_1==true"]
	[button graphic="sp1_on.png" x=100 y=200 width=520 exp="tf.cg='keeth1.png'" target="*clickcg" folder="image" ]
[else]
    [button graphic="sp1_off.png" x=100 y=200 width=520 role="none" folder="image" ]	
[endif]

[if exp="sf.keeth_cg_2==true"]
	[button graphic="sp2_on.png" x=650 y=200 width=520 exp="tf.cg='keeth2.png'" target="*clickcg" folder="image" ]
[else]
