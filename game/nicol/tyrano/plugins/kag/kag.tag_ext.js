...
tyrano.plugin.kag.tag.chara_ptext = {
    ...
    start : function(pm) {
        ...
        if(pm.name==""){
            ...
            if(pm.name=="マリア" || pm.name=="ソフィア"){
                $(".nameplate").attr("src","./data/image/name_pink.png");
            }else if(pm.name=="ニコル"){
                $(".nameplate").attr("src","./data/image/name_blue.png");
            }else{
                $(".nameplate").attr("src","./data/image/name_silver.png");
            }
        ...
        if (pm.name == "") {
            ...
            if (this.kag.stat.chara_talk_focus != "none") {
                ...
                */
                ...
                $("#tyrano_base").find(".tyrano_chara").find("img").each(function(){
                    var src = $(this).attr("src");
                    if(src.indexOf("_b.png")==-1){
                        $(this).attr("src",$.replaceAll(src,".png","_b.png"));
                    }
                });
            ...
            if (cpm) {
                ...
                if (this.kag.stat.chara_talk_focus != "none") {
                    ...
                    */
                    ...
                    //キャラのメイドを明るくする
                    $("#tyrano_base").find("." + pm.name + ".tyrano_chara").find("img").each(function(){
                        var src = $(this).attr("src");
                        if(src.indexOf("_b.png")!=-1){
                            $(this).attr("src",$.replaceAll(src,"_b.png",".png"));
                        }
                    });
                ...
                //デフォルトから　はめふら
                $("." + this.kag.stat.chara_ptext).css("color", $.convertColor("0x8b8f98"));
...
tyrano.plugin.kag.tag.chara_mod = {
    ...
    start : function(pm) {
        ...
        //現在表示が暗い場合は、変更後も暗い状態にする。
        if ($(".layer_fore").find("." + pm.name).find(".chara_img").attr("src").indexOf("_b.png") != -1) {
            storage_url = $.replaceAll(storage_url,".png","_b.png");
        }
